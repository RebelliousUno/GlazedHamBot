...
data class Track(val artist: Artist, val name: String, val streamable: String, val mbid: String, val album: Album, val url: String, val image: List<LastFMImage>, val date: LastFMDate)
...
data class LastFMAttr(val user: String, val page: String, val perPage: String, val totalPages: String, val total: String)